    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      {staff.length === 0 ? (
        <div className="card text-center py-16">
          ...
          <p className="text-gray-600 mb-6">Invite team members to help manage appointments</p>
          <Button variant="primary" onClick={openCreateModal}>
            <Plus className="w-4 h-4 mr-2" />
            ...
            <div key={member._id} className="card">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-gray-600 truncate">{member.userId?.email}</p>
                  {member.specialization && (
                    <p className="text-sm text-primary-600 mt-1">{member.specialization}</p>
                  )}
                </div>
              </div>
              ...
              <div className="flex items-center justify-between pt-4 border-t">
                <span className={`text-sm ${member.isActive ? 'text-green-600' : 'text-gray-500'}`}>

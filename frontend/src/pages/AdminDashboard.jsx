...
const AdminDashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      // Handle both string and populated object cases for businessId
      let businessId = user.businessId;
      if (typeof user.businessId === "object" && user.businessId !== null) {
      ...
      if (businessData?._id) {
        ...
        const appointmentsRes = await api.get(
          `/appointments?businessId=${businessData._id}`
        );
        ...
        const monthlyApts = appointments.filter(
          (apt) => new Date(apt.appointmentDate).getMonth() === thisMonth
        );
      ...
      // If 404/403, it means business likely doesn't exist or isn't accessible
      if (
        error.response &&
    ...
    return (
      <div className="max-w-4xl mx-auto px-4 py-16 text-center">
        ...
        <p className="text-gray-600 mb-8">
          You haven't set up your business yet. Complete the onboarding process
          to get started.
        </p>
